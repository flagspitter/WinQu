...
キーボードで手早く起動できる雑多ツール群です。
MITライセンスです。

■とりあえずの使い方
	・実行ファイルを適当なフォルダに放り込んで実行してください
...
■モジュールについて
	実行ファイルと同じフォルダモジュールに対応した.dllがあると自動的に読み込みます。

■FAQ
	Ｑ：自動起動したい
	Ａ：shell:startup にショートカットを置いてください。

	Ｑ：終了するには？
	Ａ：タスクトレイを右クリックし、表示されたメニューから Exit を選択してください。
...
■モジュール別 QuickBoard
	...
	・Ctrl+Alt+P で、クリップボードのテキストをプレーンテキストに変換します
	
	・Ctrl+Alt+Space で、現在のクリップボードをスタックします
	・Ctrl+Alt+Shit+Space で、スタックした内容をクリップボードに取り出します
